const translations = {
  en: {
    ...
    dragDropFile: 'Drag & drop a CSV or Excel file here, or click to browse',
    csvFormat: 'Supports CSV & Excel (.xlsx) — Columns: name, gender (M/F)',
  ...
  ko: {
    ...
    dragDropFile: 'CSV 또는 엑셀 파일을 여기에 끌어다 놓거나 클릭',
    csvFormat: 'CSV & 엑셀(.xlsx) 지원 — 열: 이름, 성별 (M/F)',
  ...
  zh: {
    ...
    dragDropFile: '将CSV或Excel文件拖放到此处，或点击浏览',
    csvFormat: '支持CSV和Excel(.xlsx) — 列：姓名、性别（M/F）',
